...
{
    public interface ISingleUsuarioViewModel
    {
        ...
        public Task<HttpResponseMessage> NuevoUsuario();
        public Task<HttpResponseMessage> EliminarUsuario();
        public Task<HttpResponseMessage> ActualizarUsuario();
        public Task<HttpResponseMessage> GetPerfil(string identificador);
