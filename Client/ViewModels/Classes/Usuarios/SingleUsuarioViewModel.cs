...
{
    public class SingleUsuarioViewModel : ISingleUsuarioViewModel
    {
        ...
        public SingleUsuarioViewModel()
        { }

        public SingleUsuarioViewModel(HttpClient httpClient)
        {
        ...
        public async Task<HttpResponseMessage> NuevoUsuario()
        {
            return await _httpClient.PutAsJsonAsync("usuario/nuevo", this);
        }

        public async Task<HttpResponseMessage> EliminarUsuario()
        {
            return await _httpClient.PutAsJsonAsync("usuario/eliminar", this);
        }

        public async Task<HttpResponseMessage> ActualizarUsuario()
        {
            return await _httpClient.PutAsJsonAsync("usuario/actualizar", this);
        }
        ...
        /// <returns></returns>
        public async Task<HttpResponseMessage> GetPerfil(string usuarioId)
        {
            HttpResponseMessage _response = await _httpClient.GetAsync("usuario/getusuarioporid?usuarioid=" + usuarioId);
        ...
        public static implicit operator SingleUsuarioViewModel(Usuario usuario)
        {
            return new SingleUsuarioViewModel
            {
        ...
        public static implicit operator Usuario(SingleUsuarioViewModel profileViewModel)
        {
            return new Usuario
            {
